# Employee Polls Project app by NANO DEGREE
...
- Login and Logout ( Example: `zoshikanlu` with password: `pass246`. Further login details are available in DATA.js.)
- Answer polls and create your own.
- Toggle tabs between answered and unsanswered polls
- Track your participation on the Leaderboard with highest on top
...
- `npm run test file-name` to run specific file
